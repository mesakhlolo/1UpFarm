...
const ActivePlants = ({ plants }) => {
  return (
    <div>
      <h2 className="fontPoppins fw-bold h5 font-weight-bold mb-3 ms-4">Tanaman Aktif</h2>
      <div className="scrollable row mb-4 mx-4" style={{ maxHeight: '400px', overflowY: 'auto' }}>
